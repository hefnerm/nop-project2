...
demandFactor =  1.5  # will multiply the demand (if you want to suppose that the demand increases)
period = 25       # to calculate profit you can here choose for how many years you want to plan
