...
########################################	
	...
	for e in solutionEdges:
		...
		if e[0]=='assEdge1':
			ax.arrow(coordXDic[e[2]], coordYDic[e[2]] , coordXDic[e[3]] - coordXDic[e[2]], coordYDic[e[3]] - coordYDic[e[2]], fc = "#00ff00" , ec = '#00ff00', head_width = 0.00001, head_length = 0.00001, width = 0.00001 , label='Anschlusskanten 1',zorder=1)
		elif e[0]=='assEdge2':
